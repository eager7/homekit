...
int main(void)
{
    ...
    CHECK_RESULT(eLightBulbProfileInit("22222", 0x221034235126, "12345678", "TopBand", "1234"), E_PROFILE_OK, -1);

    CHECK_RESULT(eBonjourInit(&sLightBulb, "119-76-391", "22222"), E_BONJOUR_STATUS_OK, -1);
